...
REPO="https://api.github.com/repos/elukyan/podkop-evo-json/releases/latest"
...
update_config() {
    ...
    printf "\033[48;5;196m\033[1m║ Подробности: https://github.com/elukyan/podkop-evo-json         ║\033[0m\n"
    ...
    printf "\033[48;5;196m\033[1m║ Details: https://github.com/elukyan/podkop-evo-json              ║\033[0m\n"
    ...
    while true; do
            ...
            yes|y|Y)
                ...
                wget -O /etc/config/podkop https://raw.githubusercontent.com/elukyan/podkop-evo-json/refs/heads/main/podkop/files/etc/config/podkop
...
main() {
    ...
    if command -v curl >/dev/null 2>&1; then
        check_response=$(curl -s "https://api.github.com/repos/elukyan/podkop-evo-json/releases/latest")
